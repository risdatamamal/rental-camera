<div class="container my-5">
    <div class="card bg-white border-0 mx-3 shadow">
        <div class="card-body">
            ...
            <?php endif; ?>
            <a href="<?php echo site_url('sewa/dikembalikan'); ?>" class="ml-2  btn btn-primary mb-4 btn-sm rounded-pill shadow"><i class="fa fa-list mr-1"></i> Data Yang Mengembalikan</a href="">
