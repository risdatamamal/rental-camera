    ...
    <div class="container mt-md-5 pt-md-5">
        <div class="row justify-content-center">
            <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                <img class="mb-4 rounded mx-auto d-block" src="./asset/images/logo.jpg" alt="YNC.RENTAL" width="100" height="100">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" method="POST" action="login/proses">
                            ...
                            <div class="form-group">
                                ...
                                <input name="password" type="password" id="inputPassword" class="form-control my-4" placeholder="Password" minlength="8" maxlength="10" required>
                            </div>
